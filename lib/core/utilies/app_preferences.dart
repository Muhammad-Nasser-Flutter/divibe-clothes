...
class AppPreferences {
  ...
  Future<String> getAppLanguage() async {
    String language = _sharedPreferences.getString(prefsKeyLang) ?? LanguageType.english.getValue();
    return language;
  }

  bool isEnglish() => getCurrentLanguage() == "en";
  String getCurrentLanguage() {
    return _sharedPreferences.getString(prefsKeyLang) ?? "en";
  }
  ...
  Future<void> setTheme(String mode) async => CacheHelper.saveData(key: CacheKeys.theme, value: mode);
}
